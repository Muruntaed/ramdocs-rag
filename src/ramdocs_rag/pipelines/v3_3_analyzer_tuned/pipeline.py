"""V3.3 — same pipeline as v3.2, but with a tuned analyzer prompt.

The only difference vs v3.2 is the analyzer prompt (see prompts/analyzer.txt).
Everything in the runtime — grouping, reliability, mediator, Skeptic and the
abstention fallback — is byte-identical to v3.2.
"""
...
class V33AnalyzerTuned(Pipeline):
    ...
    def describe(self) -> dict:
        ...
        base["analyzer_prompt"] = "tuned (multi-candidate disambiguation)"
        return base
